...
/* ESERCIZIO E
  Crea del codice per aggiungere programmaticamente all'oggetto precedentemente creato un array chiamato "skills", contenente 
  i linguaggi di programmazione che conosci.
*/
...
console.log('il numero maggiore è', whoIsBigger());
/* ESERCIZIO 3
  Crea una funzione chiamata "splitMe" che riceve una stringa come parametro e ritorna un'array contenente ogni parola della stringa.

  Es.: splitMe("I love coding") => ritorna ["I", "Love", "Coding"]
*/
const splitMe = function (Ilovecoding) {
  return Ilovecoding.split(' ');
};
console.log(splitMe('i love coding'));
/* ESERCIZIO 4
  Crea una funzione chiamata "deleteOne" che riceve una stringa e un booleano come parametri.
  Se il valore booleano è true la funzione deve ritornare la stringa senza il primo carattere, altrimenti la deve ritornare 
  senza l'ultimo.
*/
...
*/
const onlyLetters = function (Ihave4dogs) {
  return Ihave4dogs.replace(/\d/g, 'many');
};
...
const whatDayIsIt = function () {
  ...
  const comandoGiorno = comandoOra.getDay();
  const giornoCorrente = nomiSettimana[comandoGiorno];
...
*/
const rollTheDices = function (lanciodadi) {
  const dadi = {
    sum: 0,
    values: [],
  };
  for (let i = 0; i < lanciodadi; i++) {
    const newdice = dice();
    dadi.sum = dadi.sum + newdice;
    dadi.values.push(newdice);
  }
  return dadi;
};
